...
ActiveRecord::Schema.define(version: 2023_01_22_133317) do
  ...
  create_table "order_items", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_order_items_on_email", unique: true
    t.index ["reset_password_token"], name: "index_order_items_on_reset_password_token", unique: true
  end
